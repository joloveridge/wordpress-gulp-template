...
<div class="<?php the_sub_field('padding'); ?>">
    <div class="wrapper">
        <div class="text-icon-cols__top">
            <?php if ( get_sub_field( 'main_title' ) ): ?>
                <?php if ( get_sub_field('title_size') == true ) { ?>
                    <h2 class="large-title"><?php the_sub_field('main_title'); ?></h2>
                <?php } else { ?>
        ...
        <div class="text-icon-cols text-icon-cols--<?php the_sub_field('number_of_columns'); ?>">
        <?php if( have_rows('columns') ): ?>
            <?php while( have_rows('columns') ): the_row();
                ...
                ?>
                <div class="text-icon-cols__card">
